...
# example zebrafinch asym
# bash zebrafinch/3_build_template.sh --atlas-dir /ceph/neuroinformatics/neuroinformatics/atlas-forge/ZebraFinch --template-name template_asym_res-50um_n-3 --average-type mean
